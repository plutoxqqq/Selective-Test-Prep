...
2. Use AI
3. Pause the timer at any point
4. Ask anyone or anything for external aid
...
| **Spelling and punctuation** | Excellent accuracy in vocabulary, capitalisation, commas, and full stops. | Very good accuracy with minor errors. | Good accuracy with some noticeable errors. | Developing accuracy; frequent errors. | Limited accuracy; errors significantly affect readability. |
| **Expression and persuasive language** | Excellent sentence structure and highly effective persuasive language; strong use of linking and transition words. | Very good sentence structure and persuasive language; clear use of linking words. | Good sentence structure; some persuasive language used. | Developing sentence structure; limited persuasive techniques. | Limited sentence control; minimal or ineffective persuasive language. |
